...
def mostrar_gamificacao(nome, permissao, email, turma):
    ...
    presenca_aulasMT = ler_planilha("1iEqh0B3A5tdU7-kdZbASQDOMoT9tVR8Ja848WfEe6lM", "Streamlit | Presença nas aulas | Manhã + Tarde!A1:R")
    ...
    engajamento_plataforma = ler_planilha("1TTG9CDrZRoIKpdJKyF-BEGHAfGpWzowMTvTAi6kkWVE", "Streamlit | Engajamento na plataforma!A1:J")
    ...
    presenca_mentoria = ler_planilha("1-0lTb27DpAVCXQcseTsA4JCfSQgyQbHq5DwjykpBoMY", "Streamlit | Presença na mentoria!A1:F")
    ...
    duvidas_monitoria = ler_planilha("1Ms7u7eq5IujmVmgZsuRVcqCeJzTl_KmTREN8ilDPUuU", "Streamlit | Monitoria!A1:O")
